...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for action in self.getLegalActions(state):
          action_value_counter[action] = self.getQValue(state, action)
        return action_value_counter[action_value_counter.argMax()]
    ...
    def computeActionFromQValues(self, state):
        ...
        for action in self.getLegalActions(state):
          action_value_counter[action] = self.getQValue(state,action)
        return action_value_counter.argMax()
    ...
    def getAction(self, state):
        ...
        action = None
        "*** YOUR CODE HERE ***"
        q_action = self.computeActionFromQValues(state)
